# Microsoft Developer Studio Project File - Name="test.unit.stlsoft.algorithm.pod" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.stlsoft.algorithm.pod - Win32 Debug pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.algorithm.pod.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.algorithm.pod.mak" CFG="test.unit.stlsoft.algorithm.pod - Win32 Debug pseudoUNIX"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.stlsoft.algorithm.pod - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.stlsoft.algorithm.pod - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.stlsoft.algorithm.pod - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.stlsoft.algorithm.pod - Win32 Release"
...
!ELSEIF  "$(CFG)" == "test.unit.stlsoft.algorithm.pod - Win32 Debug"
...
!ELSEIF  "$(CFG)" == "test.unit.stlsoft.algorithm.pod - Win32 Debug pseudoUNIX"
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MDd /W3 /WX /Gm /GR /GX /Zi /Od /I "$(STLSOFT_1_10)/include" /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_AFXDLL" /D "_MBCS" /D "_CONSOLE" /YX /FD /GZ /c
...
# Name "test.unit.stlsoft.algorithm.pod - Win32 Release"
# Name "test.unit.stlsoft.algorithm.pod - Win32 Debug"
# Name "test.unit.stlsoft.algorithm.pod - Win32 Debug pseudoUNIX"
...
SOURCE=..\test.unit.stlsoft.algorithm.pod.cpp
# End Source File
# End Group
