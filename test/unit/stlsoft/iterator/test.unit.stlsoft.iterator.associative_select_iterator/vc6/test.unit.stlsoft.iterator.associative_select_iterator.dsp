# Microsoft Developer Studio Project File - Name="test.unit.stlsoft.iterator.associative_select_iterator" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.iterator.associative_select_iterator.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.iterator.associative_select_iterator.mak" CFG="test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug pseudoUNIX"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Release"
...
!ELSEIF  "$(CFG)" == "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug"
...
!ELSEIF  "$(CFG)" == "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug pseudoUNIX"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "test_unit_stlsoft_iterator_associative_select_iterator___Win32_Debug_pseudoUNIX"
# PROP BASE Intermediate_Dir "test_unit_stlsoft_iterator_associative_select_iterator___Win32_Debug_pseudoUNIX"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 1
...
# Name "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Release"
# Name "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug"
# Name "test.unit.stlsoft.iterator.associative_select_iterator - Win32 Debug pseudoUNIX"
...
SOURCE=..\test.unit.stlsoft.iterator.associative_select_iterator.cpp
# End Source File
# End Group
