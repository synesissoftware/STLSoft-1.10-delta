# Microsoft Developer Studio Project File - Name="test.unit.stlsoft.iterator.eraser_iterator" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.stlsoft.iterator.eraser_iterator - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.iterator.eraser_iterator.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.iterator.eraser_iterator.mak" CFG="test.unit.stlsoft.iterator.eraser_iterator - Win32 Debug"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.stlsoft.iterator.eraser_iterator - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.stlsoft.iterator.eraser_iterator - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.stlsoft.iterator.eraser_iterator - Win32 Release"
...
!ELSEIF  "$(CFG)" == "test.unit.stlsoft.iterator.eraser_iterator - Win32 Debug"
...
# ADD CPP /nologo /W3 /WX /Gm- /GR /GX /Zi /Od /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_CONSOLE" /FD /GZ /c
# SUBTRACT CPP /YX
...
# Name "test.unit.stlsoft.iterator.eraser_iterator - Win32 Release"
# Name "test.unit.stlsoft.iterator.eraser_iterator - Win32 Debug"
...
SOURCE=..\test.unit.stlsoft.iterator.eraser_iterator.cpp
# End Source File
# End Group
...
SOURCE="$(STLSOFT_1_10)\include\stlsoft\iterator\eraser_iterator.hpp"
# End Source File
# Begin Source File
