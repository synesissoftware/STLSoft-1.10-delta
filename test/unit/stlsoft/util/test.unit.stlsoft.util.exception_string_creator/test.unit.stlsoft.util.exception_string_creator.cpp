...
static void test_1_8()
{
    ...
    creator
        .append(L" ")
        .append(L"1234567890abcdefghijklmnopqrstuvwxyz1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ", 3u)
        ;
...
static void test_1_10()
{
    ...
    XTESTS_TEST_BOOLEAN_FALSE(creator.empty());
    XTESTS_TEST_INTEGER_EQUAL(22u, creator.size());
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL("[                    ]", creator);
    XTESTS_TEST_INTEGER_GREATER_OR_EQUAL(creator.size(), creator.capacity());
}
