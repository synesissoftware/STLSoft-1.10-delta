# Microsoft Developer Studio Project File - Name="test.unit.stlsoft.string.string_tokeniser" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.stlsoft.string.string_tokeniser - Win32 Debug pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.string.string_tokeniser.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.stlsoft.string.string_tokeniser.mak" CFG="test.unit.stlsoft.string.string_tokeniser - Win32 Debug pseudoUNIX"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.stlsoft.string.string_tokeniser - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.stlsoft.string.string_tokeniser - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.stlsoft.string.string_tokeniser - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.stlsoft.string.string_tokeniser - Win32 Release"
...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /O2 /I "$(STLSOFT_1_10)/include" /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "NDEBUG" /D "_AFXDLL" /D "_MBCS" /D "_CONSOLE" /YX /FD /c
...
!ELSEIF  "$(CFG)" == "test.unit.stlsoft.string.string_tokeniser - Win32 Debug"
...
!ELSEIF  "$(CFG)" == "test.unit.stlsoft.string.string_tokeniser - Win32 Debug pseudoUNIX"

# PROP BASE Use_MFC 2
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "test_unit_stlsoft_string_string_tokeniser___Win32_Debug_pseudoUNIX"
# PROP BASE Intermediate_Dir "test_unit_stlsoft_string_string_tokeniser___Win32_Debug_pseudoUNIX"
# PROP BASE Target_Dir ""
# PROP Use_MFC 2
# PROP Use_Debug_Libraries 1
...
# ADD CPP /nologo /MDd /W3 /WX /Gm /GR /GX /Zi /Od /I "$(STLSOFT_1_10)/include" /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "UNIX" /D "_DEBUG" /D "_AFXDLL" /D "_MBCS" /D "_CONSOLE" /D "_STLSOFT_FORCE_ANY_COMPILER" /FR /YX /FD /GZ /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0xc09 /d "_DEBUG" /d "_AFXDLL"
# ADD RSC /l 0xc09 /d "_DEBUG" /d "_AFXDLL"
...
# Name "test.unit.stlsoft.string.string_tokeniser - Win32 Release"
# Name "test.unit.stlsoft.string.string_tokeniser - Win32 Debug"
# Name "test.unit.stlsoft.string.string_tokeniser - Win32 Debug pseudoUNIX"
...
SOURCE=..\test.unit.stlsoft.string.string_tokeniser.cpp
# End Source File
# End Group
...
SOURCE="$(STLSOFT)\include\stlsoft\iterators\common\string_concatenation_flags.hpp"
# End Source File
# Begin Source File

SOURCE="$(STLSOFT_1_10)\include\stlsoft\iterator\string_concatenator.hpp"
# End Source File
# Begin Source File

SOURCE="$(STLSOFT_1_10)\include\stlsoft\iterator\string_concatenator_iterator.hpp"
# End Source File
# Begin Source File
