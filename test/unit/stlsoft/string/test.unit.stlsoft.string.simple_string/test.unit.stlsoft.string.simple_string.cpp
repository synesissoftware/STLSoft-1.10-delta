 ...
 *
 * Purpose:     Implementation file for the test.unit.stlsoft.string.simple_string project.
 *
...
static void test_ctor_range_1()
{
	...
	const string_t	s3(s1.begin(), s1.end());
...
static void test_ctor_range_2()
{
	...
	string_t		s1(alphabet);
	string_t		s2(&alphabet[0], &alphabet[0] + STLSOFT_NUM_ELEMENTS(alphabet) -1); 
	const string_t	s3(s1.rbegin(), s1.rend());
...
static void test_assign_3(void)
{
	const string_t	alphabet("abcdefghijklmnopqrstuvwxyz");
