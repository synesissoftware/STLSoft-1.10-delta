/* /////////////////////////////////////////////////////////////////////////
 * File:        test.unit.stlsoft.conversion.char_conversions.cpp
 *
 * Purpose:     Implementation file for the test.unit.stlsoft.conversion.char_conversions project.
 *
...
int main(int argc, char **argv)
{
    ...
    if(XTESTS_START_RUNNER("test.unit.stlsoft.conversion.char_conversions", verbosity))
    {
...
#ifdef STLSOFT_USE_XCOVER
        XCOVER_REPORT_FILE_COVERAGE("*stlsoft/*/char_conversions.hpp", NULL);
#endif /* STLSOFT_USE_XCOVER */
