/* /////////////////////////////////////////////////////////////////////////
 * File:        test.unit.winstl.shims.conversion.to_FILETIME.cpp
 *
 * Purpose:     Implementation file for the test.unit.winstl.shims.conversion.to_FILETIME project.
 *
...
int main(int argc, char **argv)
{
    ...
    if(XTESTS_START_RUNNER("test.unit.winstl.shims.conversion.to_FILETIME", verbosity))
    {
...
static void test_today()
{
    ...
    XTESTS_TEST_BOOLEAN_TRUE(st == winstl::to_FILETIME(st));
    ...
    XTESTS_TEST_BOOLEAN_TRUE(st == winstl::to_FILETIME(ud));
}
