/* /////////////////////////////////////////////////////////////////////////
 * File:        test.unit.winstl.shims.conversion.to_SYSTEMTIME.cpp
 *
 * Purpose:     Implementation file for the test.unit.winstl.shims.conversion.to_SYSTEMTIME project.
 *
...
int main(int argc, char **argv)
{
    ...
    if(XTESTS_START_RUNNER("test.unit.winstl.shims.conversion.to_SYSTEMTIME", verbosity))
    {
...
static void test_today()
{
    ...
    XTESTS_TEST_BOOLEAN_TRUE(st == winstl::to_SYSTEMTIME(ft));
    ...
    XTESTS_TEST_BOOLEAN_TRUE(st == winstl::to_SYSTEMTIME(ud));
}
