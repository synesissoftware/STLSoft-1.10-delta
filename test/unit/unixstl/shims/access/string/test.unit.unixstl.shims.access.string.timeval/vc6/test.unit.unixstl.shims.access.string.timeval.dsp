# Microsoft Developer Studio Project File - Name="test.unit.unixstl.shims.access.string.timeval" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.unixstl.shims.access.string.timeval - Win32 Debug pseudoUnix
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test.unit.unixstl.shims.access.string.timeval.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test.unit.unixstl.shims.access.string.timeval.mak" CFG="test.unit.unixstl.shims.access.string.timeval - Win32 Debug pseudoUnix"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test.unit.unixstl.shims.access.string.timeval - Win32 Release pseudoUnix" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.unixstl.shims.access.string.timeval - Win32 Debug pseudoUnix" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "test.unit.unixstl.shims.access.string.timeval - Win32 Release pseudoUnix"
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo /W3 /WX /GR /GX /O2 /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "UNIX" /D "_STLSOFT_FORCE_ANY_COMPILER" /D "NDEBUG" /D "_MBCS" /D "_CONSOLE" /YX /FD /c
# ADD CPP /nologo /W3 /WX /GR /GX /O2 /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "NDEBUG" /D "UNIX" /D "_STLSOFT_FORCE_ANY_COMPILER" /D "UNICODE" /D "_CONSOLE" /YX /FD /c
...
!ELSEIF  "$(CFG)" == "test.unit.unixstl.shims.access.string.timeval - Win32 Debug pseudoUnix"
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo /W3 /WX /Gm /GR /GX /Zi /Od /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "UNIX" /D "_STLSOFT_FORCE_ANY_COMPILER" /D "_DEBUG" /D "_MBCS" /D "_CONSOLE" /FR /YX /FD /GZ /c
# ADD CPP /nologo /W3 /WX /Gm /GR /GX /Zi /Od /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "_DEBUG" /D "UNIX" /D "_STLSOFT_FORCE_ANY_COMPILER" /D "UNICODE" /D "_CONSOLE" /FR /YX /FD /GZ /c
...
# Name "test.unit.unixstl.shims.access.string.timeval - Win32 Release pseudoUnix"
# Name "test.unit.unixstl.shims.access.string.timeval - Win32 Debug pseudoUnix"
...
SOURCE=..\test.unit.unixstl.shims.access.string.timeval.cpp
# End Source File
# End Group
...
SOURCE="$(STLSOFT_1_10)\include\unixstl\shims\access\string\timeval.hpp"
# End Source File
# Begin Source File
