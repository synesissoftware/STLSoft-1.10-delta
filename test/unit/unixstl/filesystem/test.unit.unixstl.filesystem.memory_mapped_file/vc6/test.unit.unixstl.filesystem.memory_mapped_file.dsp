# Microsoft Developer Studio Project File - Name="test.unit.unixstl.filesystem.memory_mapped_file" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.unixstl.filesystem.memory_mapped_file - Win32 Release pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.unixstl.filesystem.memory_mapped_file.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.unixstl.filesystem.memory_mapped_file.mak" CFG="test.unit.unixstl.filesystem.memory_mapped_file - Win32 Release pseudoUNIX"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.unixstl.filesystem.memory_mapped_file - Win32 Release pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.unixstl.filesystem.memory_mapped_file - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.unixstl.filesystem.memory_mapped_file - Win32 Release pseudoUNIX"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib advapi32.lib uuid.lib /nologo /subsystem:console /machine:I386 /libpath:"$(STLSOFT_1_10)" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(UNIXEM)/lib"

!ELSEIF  "$(CFG)" == "test.unit.unixstl.filesystem.memory_mapped_file - Win32 Debug pseudoUNIX"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib advapi32.lib uuid.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(STLSOFT_1_10)" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(UNIXEM)/lib"

!ENDIF

# Begin Target

# Name "test.unit.unixstl.filesystem.memory_mapped_file - Win32 Release pseudoUNIX"
# Name "test.unit.unixstl.filesystem.memory_mapped_file - Win32 Debug pseudoUNIX"
...
SOURCE=..\test.unit.unixstl.filesystem.memory_mapped_file.cpp
# End Source File
# End Group
