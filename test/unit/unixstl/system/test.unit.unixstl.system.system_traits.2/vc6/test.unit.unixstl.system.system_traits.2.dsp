# Microsoft Developer Studio Project File - Name="test.unit.unixstl.system.system_traits.2" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.unixstl.system.system_traits.2 - Win32 Debug pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.unixstl.system.system_traits.2.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.unixstl.system.system_traits.2.mak" CFG="test.unit.unixstl.system.system_traits.2 - Win32 Debug pseudoUNIX"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.unixstl.system.system_traits.2 - Win32 Release pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.unixstl.system.system_traits.2 - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.unixstl.system.system_traits.2 - Win32 Release pseudoUNIX"
...
# ADD CPP /nologo /W3 /WX /GR /GX /O2 /I "$(STLSOFT_1_10)/include" /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "NDEBUG" /D "UNIX" /D "_CONSOLE" /D "_STLSOFT_FORCE_ANY_COMPILER" /YX /FD /c
...
!ELSEIF  "$(CFG)" == "test.unit.unixstl.system.system_traits.2 - Win32 Debug pseudoUNIX"
...
# ADD CPP /nologo /W3 /WX /Gm /GR /GX /Zi /Od /I "$(STLSOFT_1_10)/include" /I "$(XTESTS_C_ROOT)/include" /I "$(STLSOFT)/include" /I "$(UNIXEM)/include" /D "_DEBUG" /D "UNIX" /D "_CONSOLE" /D "_STLSOFT_FORCE_ANY_COMPILER" /FR /YX /FD /GZ /c
...
# Name "test.unit.unixstl.system.system_traits.2 - Win32 Release pseudoUNIX"
# Name "test.unit.unixstl.system.system_traits.2 - Win32 Debug pseudoUNIX"
...
SOURCE=..\test.unit.unixstl.system.system_traits.2.cpp
# End Source File
# End Group
