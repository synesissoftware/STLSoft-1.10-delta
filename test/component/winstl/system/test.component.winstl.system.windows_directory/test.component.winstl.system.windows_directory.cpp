/* /////////////////////////////////////////////////////////////////////////
 * File:        test.component.winstl.system.windows_directory.cpp
 *
 * Purpose:     Implementation file for the test.component.winstl.system.windows_directory project.
 *
...
int main(int argc, char **argv)
{
    ...
    if(XTESTS_START_RUNNER("test.component.winstl.system.windows_directory", verbosity))
    {
...
#ifdef STLSOFT_USE_XCOVER
        XCOVER_REPORT_FILE_COVERAGE("*winstl/*/windows_directory.hpp", NULL);
#endif /* STLSOFT_USE_XCOVER */
...
namespace
{
    ...
    static string_t get_temp_dir()
    {
        ...
        DWORD   dw = ::GetWindowsDirectory(path, STLSOFT_NUM_ELEMENTS(path)); 
