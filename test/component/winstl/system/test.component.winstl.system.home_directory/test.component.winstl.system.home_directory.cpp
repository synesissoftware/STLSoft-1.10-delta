/* /////////////////////////////////////////////////////////////////////////
 * File:        test.component.winstl.system.home_directory.cpp
 *
 * Purpose:     Implementation file for the test.component.winstl.system.home_directory project.
 *
...
int main(int argc, char **argv)
{
    ...
    if(XTESTS_START_RUNNER("test.component.winstl.system.home_directory", verbosity))
    {
...
#ifdef STLSOFT_USE_XCOVER
        XCOVER_REPORT_FILE_COVERAGE("*winstl/*/home_directory.hpp", NULL);
#endif /* STLSOFT_USE_XCOVER */
...
{
    winstl::home_directory_a		HOME;

	winstl::environment_variable_a	HOMEDRIVE("HOMEDRIVE");
	winstl::environment_variable_a	HOMEPATH("HOMEPATH");

	XTESTS_TEST_INTEGER_EQUAL(HOMEDRIVE.size() + HOMEPATH.size(), HOME.size());
	XTESTS_TEST_MULTIBYTE_STRING_EQUAL(std::string(HOMEDRIVE) + std::string(HOMEPATH), HOME);
}
