/* /////////////////////////////////////////////////////////////////////////
 * File:        test.component.winstl.filesystem.memory_map_functions.cpp
 *
 * Purpose:     Implementation file for the test.component.winstl.filesystem.memory_map_functions project.
 *
...
int main(int argc, char **argv)
{
    ...
    if(XTESTS_START_RUNNER_WITH_SETUP_FNS("test.component.winstl.filesystem.memory_map_functions", verbosity, setup, teardown, NULL))
	{
...
static void test_1_0()
{
    ...
    void*           view = winstl::map_readonly_view_of_file_by_name(TEST_FILE_NAME, GENERIC_READ, 0, 0, 0, &viewSize);
    ...
    if(NULL != view)
    {
        ...
        winstl::unmap_view_of_file(view);
    }
}
...
static void test_1_1()
{
    ...
    void*           view        =   winstl::map_readonly_view_of_file_by_name(TEST_FILE_NAME, GENERIC_READ, 0, offset, requestSize, &viewSize);
...
static void test_1_3()
{
    ...
    {
        views[i] = winstl::map_readonly_view_of_file_by_name(TEST_FILE_NAME, GENERIC_READ, 0, 0, 0, &viewSizes[i]);
    ...
    {
        winstl::unmap_view_of_file(views[i]);
    }}
}
