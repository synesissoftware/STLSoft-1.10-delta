/* /////////////////////////////////////////////////////////////////////////
 * File:        test.component.unixstl.filesystem.memory_map_functions.C.c
 *
 * Purpose:     Implementation file for the test.component.unixstl.filesystem.memory_map_functions.C project.
 *
...
#include <stlsoft/stlsoft.h>
/* #include <unixstl/filesystem/file_size_functions.h> */
...
int main(int argc, char **argv)
{
    ...
    if(XTESTS_START_RUNNER_WITH_SETUP_FNS("test.component.unixstl.filesystem.memory_map_functions.C", verbosity, setup, teardown, NULL))
    {
...
static void test_1_0()
{
    ...
    void*           view = unixstl_C_map_readonly_view_of_file_by_name_a(TEST_FILE_NAME, GENERIC_READ, 0, 0, 0, &viewSize);
...
static void test_1_3()
{
    ...
    {
        views[i] = unixstl_C_map_readonly_view_of_file_by_name_a(TEST_FILE_NAME, GENERIC_READ, 0, 0, 0, &viewSizes[i]);
    ...
    {
        unixstl_C_unmap_view_of_file(views[i]);
    }}
}
