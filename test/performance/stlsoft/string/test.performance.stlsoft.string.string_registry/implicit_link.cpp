 ...
 *
 * Purpose:     Implicit link file for the test.performance.stlsoft.string.string_registry project.
 *
...
{
    PANTHEIOS_BE_N_FILTERED_ENTRY(1, pantheios_be_WindowsConsole, PANTHEIOS_SEV_WARNING, 0),
#if defined(PLATFORMSTL_OS_IS_UNIX)
