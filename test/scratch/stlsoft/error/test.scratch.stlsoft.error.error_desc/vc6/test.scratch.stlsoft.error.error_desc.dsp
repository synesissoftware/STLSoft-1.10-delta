# Microsoft Developer Studio Project File - Name="test.scratch.stlsoft.error.error_desc" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.scratch.stlsoft.error.error_desc - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.stlsoft.error.error_desc.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.stlsoft.error.error_desc.mak" CFG="test.scratch.stlsoft.error.error_desc - Win32 Debug"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.scratch.stlsoft.error.error_desc - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.stlsoft.error.error_desc - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.scratch.stlsoft.error.error_desc - Win32 Release"
...
# ADD CPP /nologo /W3 /GX /O2 /I "$(STLSOFT)/include" /I "$(FASTFORMAT_ROOT)/include" /D "WIN32" /D "NDEBUG" /D "STRICT" /D "_CONSOLE" /YX /FD /c
...
!ELSEIF  "$(CFG)" == "test.scratch.stlsoft.error.error_desc - Win32 Debug"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "$(STLSOFT)/include" /I "$(FASTFORMAT_ROOT)/include" /D "WIN32" /D "_DEBUG" /D "STRICT" /D "_CONSOLE" /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib advapi32.lib /nologo /version:1.0 /subsystem:console /map /debug /machine:I386 /out:"Debug/test.scratch.stlsoft.error.error_desc.debug.exe" /pdbtype:sept /libpath:"$(FASTFORMAT_ROOT)/lib"
# SUBTRACT LINK32 /pdb:none
...
# Name "test.scratch.stlsoft.error.error_desc - Win32 Release"
# Name "test.scratch.stlsoft.error.error_desc - Win32 Debug"
...
SOURCE=..\test.scratch.stlsoft.error.error_desc.cpp
# End Source File
# End Group
